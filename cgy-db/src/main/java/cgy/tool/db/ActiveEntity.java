...
public class ActiveEntity extends Entity {
	...
	private final cn.hutool.db.Db db;
	 ...
	 */
	public ActiveEntity() {
		this(cn.hutool.db.Db.use(), (String) null);
	}
	...
	public ActiveEntity(String tableName) {
		this(cn.hutool.db.Db.use(), tableName);
	}
	...
	public ActiveEntity(Entity entity) {
		this(cn.hutool.db.Db.use(), entity);
	}

	/**
	 * 构造
	 * 
	 * @param db {@link cn.hutool.db.Db}
	 * @param tableName 表名
	 */
	public ActiveEntity(cn.hutool.db.Db db, String tableName) {
		super(tableName);
		this.db = db;
	}
	 ...
	 * @param entity 非动态实体
	 */
	public ActiveEntity(cn.hutool.db.Db db, Entity entity) {
