...
public final class DbUtil {
	 ...
	 */
	@Deprecated
	public static cn.hutool.db.SqlRunner newSqlRunner() {
		return cn.hutool.db.SqlRunner.create(getDs());
	}
	 ...
	 */
	@Deprecated
	public static cn.hutool.db.SqlRunner newSqlRunner(DataSource ds) {
		return cn.hutool.db.SqlRunner.create(ds);
	}
	 ...
	 */
	@Deprecated
	public static cn.hutool.db.SqlRunner newSqlRunner(DataSource ds, Dialect dialect) {
		return cn.hutool.db.SqlRunner.create(ds, dialect);
	}
	 ...
	 * @return SQL执行类
	 */
	public static cn.hutool.db.Db use() {
	 ...
	 * @return SQL执行类
	 */
	public static cn.hutool.db.Db use(DataSource ds) {
		return cn.hutool.db.Db.use(ds);
	}
	 ...
	 * @return SQL执行类
	 */
	public static cn.hutool.db.Db use(DataSource ds, Dialect dialect) {
		return cn.hutool.db.Db.use(ds, dialect);
	}
	 ...
	 * @return 数据库会话
	 */
	public static cn.hutool.db.Session newSession() {
		return cn.hutool.db.Session.create(getDs());
	}
	 ...
	 * @return 数据库会话
	 */
	public static cn.hutool.db.Session newSession(DataSource ds) {
		return cn.hutool.db.Session.create(ds);
	}
	...
	public static DataSource getJndiDsWithLog(String jndiName) {
		...
		} catch (cn.hutool.db.DbRuntimeException e) {
	...
	public static DataSource getJndiDs(String jndiName) {
		try {
			...
			throw new cn.hutool.db.DbRuntimeException(e);
		}
	}
	...
	public static void setShowSqlGlobal(boolean isShowSql, boolean isFormatSql, boolean isShowParams, Level level) {
		cn.hutool.db.GlobalDbConfig.setShowSql(isShowSql, isFormatSql, isShowParams, level);
	}
	...
	public static void setCaseInsensitiveGlobal(boolean caseInsensitive) {
		cn.hutool.db.GlobalDbConfig.setCaseInsensitive(caseInsensitive);
	}
	...
	public static void setReturnGeneratedKeyGlobal(boolean returnGeneratedKey) {
		cn.hutool.db.GlobalDbConfig.setReturnGeneratedKey(returnGeneratedKey);
	}
}
